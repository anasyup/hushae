                        ...
                        {selectedTemplate.variables.map((v) => (
                          <div key={v} className="inline-flex rounded-md border border-neutral-200 bg-neutral-50 p-1">
                            <button
                              ...
                              className="px-1.5 py-0.5 text-[10px] font-mono font-medium hover:bg-neutral-200 rounded text-neutral-700"
                            ...
                            <button
                              ...
                              className="px-1.5 py-0.5 text-[10px] font-mono font-bold hover:bg-neutral-200 rounded text-neutral-900"
