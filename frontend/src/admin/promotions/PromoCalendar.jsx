  ...
  return (
    <li>
      ...
      >
        ...
        <span className={`shrink-0 text-[11px] ${tone === 'warn' ? 'font-semibold text-amber-900' : 'text-neutral-600'}`}>{note}</span>
      </Link>
    </li>
  );
}
            ...
            return (
              <li key={p._id}>
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block truncate text-[13px] font-medium text-neutral-900">{p.name}</span>
                    <span className="mt-0.5 block text-[11px] text-neutral-600">{note}</span>
                  </span>
                  <span className={`shrink-0 rounded-full px-2 py-0.5 text-[11px] font-semibold ${p.state?.reason === 'live' ? 'bg-emerald-50 text-emerald-800' : 'bg-neutral-100 text-neutral-600'}`}>
