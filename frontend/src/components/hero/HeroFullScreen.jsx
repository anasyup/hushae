...
export default function HeroFullScreen({ hero }) {
  ...
  // Home is a fashion cover, not a settings screen: its type is intentionally
  // centred so the photograph has one calm focal point on every viewport.
  const centred = true;
  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center px-5 pb-16 text-center md:px-8 md:pb-24 xl:max-w-[1360px] xl:px-10 xl:pb-28 2xl:max-w-[1560px] 2xl:px-14 2xl:pb-32 3xl:max-w-shell 3xl:px-16`}>
