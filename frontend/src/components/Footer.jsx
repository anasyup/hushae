    ...
    <footer className="mt-24 border-t border-line bg-satin/40">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-4 md:px-8">
        ...
        <div>
          ...
          <p className="mt-5 flex items-center gap-2 text-[11px] uppercase tracking-widest text-ash"><CreditCard size={14} /> COD</p>
        </div>
      </div>
      <div className="border-t border-line/70 py-5 text-center text-[11px] uppercase tracking-widest text-ash">
        &copy; {new Date().getFullYear()} HUSHAE · All rights reserved · Discreet always
      </div>
    </footer>
  );
}
