...
S({
  ...
  blocks: [
    ...
    },
    {
      ...
      settings: [
        { type: 'range', id: 'gap', label: 'Link spacing', min: 8, max: 48, step: 2, unit: 'px', default: 28 },
        { type: 'range', id: 'size', label: 'Font size', min: 9, max: 18, step: 1, unit: 'px', default: 12 },
  ...
  settings: [
    ...
    { type: 'range', id: 'height', label: 'Height', min: 48, max: 120, step: 2, unit: 'px', default: 64 },
