      ...
      {loading && !d ? (
        ...
        <div className="space-y-5">
          ...
          {d?.device && Object.keys(d.device).length > 0 && (
            <section className="rounded-2xl border border-neutral-200 bg-white p-5">
              <p className="text-[12px] font-bold uppercase tracking-widest text-neutral-600">Where they search from</p>
              <div className="mt-4 grid grid-cols-3 gap-3">
                {['mobile', 'tablet', 'desktop'].map((k) => (
                  <div key={k} className="rounded-xl bg-neutral-50 px-4 py-3">
                    <p className="text-[12px] capitalize text-neutral-600">{k}</p>
