...
export default function Search() {
  ...
  return (
    <div className="container-page pt-[130px] pb-6 md:pb-10"><Seo title={q ? `Results for “${q}”` : 'Search'} description="Search HUSHAE — innerwear made in Pakistan, finished to an international standard." />
      {/* ---------------- header ----------------
