...
export default function Checkout() {
  ...
  if (cart.length === 0) {
    return (
      <div className="container-page py-sect-y text-center md:py-sect-y-lg pt-[220px]"><Seo title="Checkout" description="Complete your order — COD, JazzCash and card payments, discreet packaging." />
  ...
  return (
    <div className="bg-white pt-[220px] pb-10"><Seo title="Checkout" description="Complete your order — COD, JazzCash and card payments, discreet packaging." /><div className="mx-auto max-w-[1200px] px-6">
