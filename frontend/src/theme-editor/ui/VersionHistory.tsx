  ...
  return (
    <div className="absolute inset-0 z-40 flex flex-col bg-white">
      <div className="flex items-center gap-2 border-b border-neutral-200 px-3 py-3">
        ...
        <p className="flex-1 text-[14px] font-semibold text-neutral-900">Version history</p>
      ...
      <div className="te-scroll flex-1 overflow-y-auto p-2.5">
        ...
        {versions.map((v) => (
          <div key={v._id}
            className={`mb-1.5 rounded-lg border p-3 transition ${previewing === v._id ? 'border-[#005BD3] bg-[#005BD3]/5' : 'border-neutral-200'}`}>
            ...
            <div className="mt-2.5 flex gap-1.5">
              <button
                ...
                className="flex-1 rounded-md border border-neutral-300 py-1.5 text-[11.5px] font-semibold text-neutral-700 transition hover:bg-neutral-50">
              ...
              <button
                ...
                className="flex flex-1 items-center justify-center gap-1 rounded-md bg-neutral-900 py-1.5 text-[11.5px] font-semibold text-white transition hover:bg-black">
