  ...
  return (
    <div>
      ...
      <input
        ...
        {...rest}
      />
      {hint && <p id={`${id}-h`} className="mt-1.5 text-[11px] leading-relaxed text-neutral-500">{hint}</p>}
    </div>
  );
};
        ...
        >
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              />
              <p id="loy-spend-per-point-h" className="mt-1.5 text-[11px] leading-relaxed text-neutral-500">
                {spendPerPoint > 0
