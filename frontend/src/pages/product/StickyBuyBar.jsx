    ...
    >
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 pt-3 md:px-8 lg:gap-6 xl:max-w-[1360px] xl:px-10 2xl:max-w-[1560px] 2xl:px-14 3xl:max-w-shell 3xl:px-16">
        ...
        <button
          ...
          onClick={onAdd}
          disabled={disabled}
          className="min-h-[48px] shrink-0 bg-charcoal px-8 text-[11px] font-medium uppercase tracking-[0.2em] text-white transition-colors duration-300 hover:bg-charcoal disabled:pointer-events-none disabled:opacity-50 lg:min-w-[210px]"
        >
