...
export const THEME_GROUPS: ThemeGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { type: 'font_picker', id: 'fontHeading', label: 'Heading font', default: 'Cormorant Garamond' },
      ...
      { type: 'font_picker', id: 'fontBody', label: 'Body font', default: 'Inter' },
...
export function themeToCssVars(t: SettingsBag): Record<string, string> {
  ...
  return {
    ...
    '--t-font-heading': `"${v('fontHeading', 'Cormorant Garamond')}", Georgia, serif`,
    '--t-font-body': `"${v('fontBody', 'Inter')}", system-ui, sans-serif`,
