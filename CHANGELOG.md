...
- **2026-08-11** — 🃏 **CARD — Givenchy studio canvas reference**: bar variant rewritten — 3/4 canvas `#f2f0ec` `p-6`, images `object-contain + mix-blend-multiply`, hover = secondary crossfade (no zoom), arrows + dash indicators kept, floating "+" (bottom-right) opens IN-CARD size overlay, details CENTERED (title 11/12px medium uppercase tracking 0.15em, price 11px medium tracking-wider + struck old).
