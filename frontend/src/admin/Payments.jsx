              ...
              return (
                <div key={name} className="rounded-xl border border-neutral-100 bg-neutral-50/60 p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right"><p className="font-sans text-[15px] font-semibold tabular-nums">{pkr(m.value)}</p><p className="text-[11px] text-neutral-500">{pct.toFixed(1)}%</p></div>
                  </div>
...
function KpiCard({ icon: Icon, label, value, sub, change, tone = 'neutral' }) {
  ...
  return (
    <div className="rounded-2xl border border-neutral-200 bg-white p-5 transition hover:-translate-y-0.5 hover:shadow-sm">
      ...
      <p className="mt-1 font-sans text-[22px] font-semibold tabular-nums leading-none tracking-tight text-neutral-900">{value}</p>
