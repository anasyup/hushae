...
- **2026-08-11** — 🎛️ **LISTING PAGE — exact reference align**: Shop page bg → `#fcfbf9` (was white) with `min-h-screen`, matching the CleanListingPage reference (filter pills + All Filters + "N Items" + Sort By are already the LuxuryFilterBar).
