...
export default function OrderDetail() {
  ...
  if (!auth) {
    return (
      <div className="container-page py-sect-y text-center pt-[220px]">
  ...
  if (!data) {
    return (
      ...
      <div className="container-page pt-[220px] pb-8 md:pb-12" role="status" aria-live="polite">
...
<style>body{font-family:Jost,Helvetica,Arial,sans-serif;max-width:720px;margin:40px auto;padding:0 24px;color:#1A1A1A}
...
<script>window.onload=()=>window.print()<\/script></body></html>`);
  ...
  return (
    <div className="container-page pt-[220px] pb-8 md:pb-12">
