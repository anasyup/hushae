    ...
    <AdminLayout title="Live View">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-6">
          <p className="mb-5 flex items-center gap-2 text-[12px] font-bold uppercase tracking-widest text-neutral-500"><Activity size={14} /> Customer behaviour — today</p>
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-6 lg:col-span-2">
          <p className="mb-1 flex items-center gap-2 text-[12px] font-bold uppercase tracking-widest text-neutral-500"><MapPin size={14} /> Sessions by location — today</p>
          <p className="mb-4 text-[12px] leading-relaxed text-neutral-500">Shehar visitor ke network (IP) se milta hai — VPN ya mobile network (Jazz/Telenor) ki wajah se qareebi shehar bhi dikh sakta hai. Ye GPS nahi, approximate area hai.</p>
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white mt-6 p-6">
        <p className="mb-4 text-[12px] font-bold uppercase tracking-widest text-neutral-500">Live activity feed</p>
