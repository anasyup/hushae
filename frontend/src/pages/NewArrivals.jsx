...
/* ============================================================================
 * NEW ARRIVALS PAGE — exact client reference.
 *   · container: bg-[#FAF8F5] pt-20 pb-24 px-4 sm:px-6 lg:px-8
 *   · centred header: Collection '26 · serif NEW ARRIVALS · description
 *   · centred tabs ALL / WOMEN / MEN / LOUNGEWEAR (underline active)
 *   · 'N Products' + Filters (opens the real filter sheet)
 *   · grid gap-x-4 gap-y-10, 1/2/4 cols
 *   · Versace editorial banners: col-span-1 sm:col-span-2 row-span-2
 *     min-h-[520px] with serif title + arrow CTA
 *   · product card (reference-exact): aspect-[4/5] image on #EFECE6 with
 *     hover scale-[1.02], solid BLACK square badge top-right, title 11px
 *     semibold tracking-wider uppercase, colour dots BELOW the title,
 *     price (struck original first, then bold current)
...
export default function NewArrivalsPage() {
  ...
  return (
    <div className="w-full bg-[#FAF8F5] px-4 pb-24 pt-20 font-sans text-[#111111] sm:px-6 lg:px-8">
 ...
 *   · 4/5 image on #EFECE6, hover scale-[1.02]
 *   · solid BLACK square badge top-right
 *   · title (11px semibold tracking-wider uppercase leading-tight)
 *   · colour dots BELOW the title (w-2.5 h-2.5, bordered)
