          ...
          <div className="flex items-center justify-between border-b border-neutral-100 px-4 py-3">
            ...
            {data.unread > 0 && (
              <button onClick={markAll} disabled={busy}
                className="text-[11px] font-semibold text-neutral-500 transition hover:text-neutral-900 disabled:opacity-50">
                Mark all as read
              </button>
            )}
          </div>
              ...
              return (
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block truncate text-[12.5px] font-semibold text-neutral-900">{n.title}</span>
                    {n.body && <span className="mt-0.5 block line-clamp-2 text-[11.5px] leading-snug text-neutral-500">{n.body}</span>}
                    <span className="mt-1 block text-[10.5px] text-neutral-400">{ago(n.at)}</span>
                  </span>
