  ...
  return (
    <AdminLayout title="Store Settings">
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white mb-6 p-6">
        <p className="mb-2 text-[11px] font-bold uppercase tracking-widest text-neutral-500">Appearance — admin panel</p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-neutral-200 bg-white space-y-5 p-6">
          <p className="text-[11px] font-bold uppercase tracking-widest text-neutral-500">Store</p>
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white space-y-5 p-6">
          <p className="text-[11px] font-bold uppercase tracking-widest text-neutral-500">Homepage hero</p>
          <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Title</label><textarea className="w-full rounded-xl border border-neutral-300 bg-white px-4 py-2.5 text-[12px] outline-none transition focus:border-neutral-900 min-h-16" value={s.hero.title} onChange={(e) => setHero('title', e.target.value)} /></div>
          <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Subtitle</label><textarea className="w-full rounded-xl border border-neutral-300 bg-white px-4 py-2.5 text-[12px] outline-none transition focus:border-neutral-900 min-h-16" value={s.hero.subtitle} onChange={(e) => setHero('subtitle', e.target.value)} /></div>
          <div className="grid grid-cols-2 gap-4">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white space-y-5 p-6">
          <div className="flex items-center justify-between">
            <p className="text-[11px] font-bold uppercase tracking-widest text-neutral-500">Sale &amp; offer bar</p>
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white space-y-4 p-6">
          <p className="text-[11px] font-bold uppercase tracking-widest text-neutral-500">Trust badges</p>
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white space-y-5 p-6">
          <p className="text-[11px] font-bold uppercase tracking-widest text-neutral-500">Shipping & payments</p>
          <div className="grid grid-cols-2 gap-4">
          ...
          <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Bank details (shown at checkout)</label><textarea className="w-full rounded-xl border border-neutral-300 bg-white px-4 py-2.5 text-[12px] outline-none transition focus:border-neutral-900 min-h-20 font-mono text-xs" value={s.paymentMethods.bankDetails} onChange={(e) => setPM('bankDetails', e.target.value)} /></div>
        </div>
      </div>
  ...
  return (
    <form onSubmit={submit} className="rounded-2xl border border-neutral-200 bg-white mt-6 space-y-5 p-6">
      <div className="flex items-center gap-2">
        ...
        <p className="text-[11px] font-bold uppercase tracking-widest text-neutral-500">Change password</p>
      </div>
