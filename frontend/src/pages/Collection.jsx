...
export default function Collection() {
  ...
  if (err) {
    return (
      <div className="container-page pt-[140px] pb-24 text-center">
  ...
  if (!data) return (
    <div className="px-5 pt-[140px] pb-10 md:px-10">
  ...
  return (
    <div className="w-full min-h-screen bg-[#fcfbf9] pt-[140px] font-sans text-black">
      <Seo
        title={c.name}
