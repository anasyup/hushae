        ...
        <div className="grid gap-4 md:grid-cols-4 mb-6">
          <div className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[13px] font-bold uppercase tracking-widest text-neutral-500">Abandoned Carts</p>
            </div>
            <p className="mt-2 text-[12px] font-bold text-neutral-900">{m.abandonedCartCount}</p>
            <p className="text-[12px] text-neutral-500 mt-1">Carts awaiting checkout</p>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[13px] font-bold uppercase tracking-widest text-neutral-500">Email Delivery / Open</p>
            </div>
            <p className="mt-2 text-[12px] font-bold text-neutral-900">{m.emailDeliveryRate}% / {m.emailOpenRate}%</p>
            <p className="text-[12px] text-neutral-500 mt-1">SMTP Connection Healthy</p>
          </div>

          <div className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-2">
              <Star size={14} className="text-neutral-500" />
              <p className="text-[13px] font-bold uppercase tracking-widest text-neutral-500">Review Request Response</p>
            </div>
            <p className="mt-2 text-[12px] font-bold text-neutral-900">{m.responseRate}%</p>
            <p className="text-[12px] text-neutral-500 mt-1">{m.reviewsCount} reviews from {m.reviewRequestsCount} requests</p>
          </div>
        </div>
            ...
            <div className="space-y-4">
              <label className="flex cursor-pointer items-start justify-between gap-4 rounded-xl border border-neutral-200 bg-neutral-50 px-4 py-3">
                <div className="min-w-0">
                  ...
                  <p className="text-[12px] text-neutral-500">Sends the transactional "Abandoned Cart" template if checkout is incomplete.</p>
                </div>
                <span
              ...
              <div className={auto.abandonedCart?.enabled ? '' : 'pointer-events-none opacity-40'}>
                <label className="mb-1 block text-[13px] font-bold uppercase tracking-wider text-neutral-500">Timing: Send Email After (Hours)</label>
                <input
                  type="number"
                ...
                />
                <p className="text-[12px] text-neutral-500 mt-1">Recommended is 2 hours. Gives the customer enough time to return without losing intent.</p>
              </div>
            ...
            <div className="space-y-4">
              <label className="flex cursor-pointer items-start justify-between gap-4 rounded-xl border border-neutral-200 bg-neutral-50 px-4 py-3">
                <div className="min-w-0">
                  ...
                  <p className="text-[12px] text-neutral-500">Triggers transactional "Review Request" email template after order delivery.</p>
                </div>
                <span
              ...
              <div className={auto.reviewRequest?.enabled ? '' : 'pointer-events-none opacity-40'}>
                <label className="mb-1 block text-[13px] font-bold uppercase tracking-wider text-neutral-500">Timing: Send Email After (Days)</label>
                <input
                  type="number"
                  className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[12px] outline-none transition focus:border-neutral-900 !w-32"
                  min={1}
                ...
                />
                <p className="text-[12px] text-neutral-500 mt-1">Recommended is 7 days. Gives the customer ample time to wear and wash before rating.</p>
              </div>
