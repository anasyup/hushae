...
export default function EditorialStory({
  ...
  return (
    <section
      ...
      className="relative mt-ed-md xl:left-1/2 xl:mt-ed-lg xl:w-[100dvw] xl:-translate-x-1/2"
    >
        ...
        <div className="absolute inset-x-0 bottom-0">
          <div className="container-page pb-10 md:pb-14 xl:pb-20">
            <div className="max-w-[46ch]">
              ...
              <h2
                id="story-title"
                className="mt-4 whitespace-pre-line font-serif text-display-2 font-light italic leading-[0.96] text-alabaster"
              >
                {title}
              </h2>
