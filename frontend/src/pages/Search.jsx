    ...
    <div className="container-page pt-[220px] pb-6 md:pb-10"><Seo title={q ? `Results for “${q}”` : 'Search'} description="Search HUSHAE — innerwear made in Pakistan, finished to an international standard." />
      ...
      <div className="grid gap-8 lg:grid-cols-[240px_minmax(0,1fr)] xl:gap-12 2xl:grid-cols-[268px_minmax(0,1fr)] 2xl:gap-16 3xl:grid-cols-[288px_minmax(0,1fr)]">
        ...
        <div className="min-w-0">
          {loading ? (
            <div className="grid grid-cols-2 gap-0 border-t border-l border-neutral-200/80 lg:grid-cols-4" aria-hidden="true">
            ...
            <div>
              ...
              {data?.recovery?.products?.length > 0 && (
                <section className="mt-10" aria-labelledby="rec-popular">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-0 border-t border-l border-neutral-200/80 lg:grid-cols-4">
