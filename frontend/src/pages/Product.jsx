...
export default function Product() {
  ...
  if (err) {
    return (
      <div className="mx-auto max-w-[1440px] px-5 pt-[170px] pb-24 text-center">
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] pt-[170px] pb-20 font-sans text-[#1A1A1A] antialiased lg:pb-0">
      <Seo
        title={name}
