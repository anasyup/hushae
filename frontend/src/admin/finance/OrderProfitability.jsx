    ...
    <section className="mt-6 rounded-2xl border border-neutral-200 bg-white p-5 sm:p-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="text-[11px] font-bold uppercase tracking-widest text-neutral-500">Order profitability</p>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button onClick={() => setSort('margin-asc')}
            className={`min-h-[34px] rounded-full border px-3 text-[11px] font-semibold transition ${sort === 'margin-asc' ? 'border-neutral-900 bg-neutral-900 text-white' : 'border-neutral-200 bg-white text-neutral-700 hover:bg-neutral-50'}`}>
            Worst first
          </button>
          <button onClick={exportCsv}
            className="inline-flex min-h-[34px] items-center gap-1.5 rounded-full border border-neutral-200 bg-white px-3 text-[11px] font-semibold text-neutral-700 transition hover:bg-neutral-50">
      ...
      <p className="mt-3 flex items-start gap-2 rounded-lg bg-blue-50 px-3 py-2 text-[11px] leading-relaxed text-blue-800">
              ...
              return (
                <Fragment key={r.id}>
                  ...
                  >
                    ...
                    <td className="py-2.5 font-mono text-[11.5px] font-semibold text-neutral-900">{r.orderNumber}</td>
                          ...
                          <div className="max-w-sm">
                            ...
                            <dl className="space-y-1">
                              ...
                              <div className="!mt-2 flex items-center justify-between border-t border-neutral-300 pt-2">
                                ...
                                <dd className={`font-sans text-[14px] font-bold tabular-nums ${r.netProfit >= 0 ? 'text-emerald-700' : 'text-red-700'}`}>
                                  {pkr(r.netProfit)} {r.revenue > 0 && <span className="text-[11px] font-semibold">({r.margin}%)</span>}
                                </dd>
                              </div>
                            </dl>
                          </div>
                          <div className="space-y-2 text-[11.5px] text-neutral-600">
...
function Line({ label, value, strong }) {
  return (
    <div className="flex items-center justify-between gap-4">
      <dt className={`text-[11.5px] ${strong ? 'font-semibold text-neutral-800' : 'text-neutral-500'}`}>{label}</dt>
