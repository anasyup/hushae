    ...
    <div className="rounded-2xl border border-neutral-200 bg-white p-5 sm:p-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="flex items-center gap-2 text-[12px] font-bold uppercase tracking-widest text-neutral-500">
    ...
    <div className="rounded-2xl border border-neutral-200 bg-white p-5 sm:p-6">
      ...
      {d.risky.length > 0 && (
        <div className="mt-4 border-t border-neutral-100 pt-3">
          <p className="text-[13px] font-bold uppercase tracking-widest text-neutral-500">Customers who cancel or return most</p>
...
export function BreakEven({ days, from, to }) {
  ...
  return (
    <div className="rounded-2xl border border-neutral-200 bg-white p-5 sm:p-6">
      <p className="text-[12px] font-bold uppercase tracking-widest text-neutral-500">Break-even</p>
      ...
      {unset ? (
        ...
        <>
          ...
          <dl className="mt-4 space-y-1.5 border-t border-neutral-100 pt-3 text-[13px]">
            {[
