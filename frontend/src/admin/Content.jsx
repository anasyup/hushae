    ...
    <AdminLayout title="Content">
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className="mb-6 rounded-2xl border border-neutral-200 bg-white/40 p-4">
              <p className="mb-3 text-[9px] font-bold uppercase tracking-widest text-emerald-700">Text Content</p>
              <div className="space-y-3">
                <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Small tagline (above title)</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={hero.eyebrow || ''} onChange={(e) => setHero('eyebrow', e.target.value)} placeholder="Premium innerwear · Made in Pakistan" /></div>
                <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Main title</label><textarea className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 min-h-16" value={hero.title || ''} onChange={(e) => setHero('title', e.target.value)} placeholder={'Second Skin,\nFirst Choice.'} /><p className="mt-1 text-[9px] text-neutral-500">Press Enter for a new line</p></div>
                <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Subtitle</label><textarea className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 min-h-20" value={hero.subtitle || ''} onChange={(e) => setHero('subtitle', e.target.value)} placeholder="A short description shown below the title" /></div>
              </div>
            </div>
            ...
            <div className="mb-6 rounded-2xl border border-neutral-200 bg-white/40 p-4">
              <div className="mb-3 flex items-center justify-between">
                <p className="text-[9px] font-bold uppercase tracking-widest text-emerald-700">Call-to-Action Buttons</p>
              ...
              {hero.showButtons === false ? (
                ...
                <>
                  ...
                  {hero.ctaStyle === 'dropdown' ? (
                    <>
                      <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Button text</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={hero.ctaWomen || ''} onChange={(e) => setHero('ctaWomen', e.target.value)} placeholder="Shop Now" /></div>
                      <div className="mt-3">
                        <label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Dropdown menu items</label>
                        <p className="mt-1 text-[9px] text-neutral-500">One item per line — format: <code className="rounded bg-neutral-100 px-1">Label | /link</code></p>
                        <textarea className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 mt-2 min-h-32 font-mono text-[9px]"
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Button 1 label (Women)</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={hero.ctaWomen || ''} onChange={(e) => setHero('ctaWomen', e.target.value)} placeholder="Shop Women" /></div>
                      <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Button 2 label (Men)</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={hero.ctaMen || ''} onChange={(e) => setHero('ctaMen', e.target.value)} placeholder="Shop Men" /></div>
                    </div>
                  )}
                </>
              )}
            ...
            {/* MEDIA */}
            <div className="mb-6 rounded-2xl border border-neutral-200 bg-white/40 p-4">
              <p className="mb-3 text-[9px] font-bold uppercase tracking-widest text-emerald-700">Background Media</p>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-[9px] text-neutral-500">Recommended: 1920 × 1080 (16:9). Upload a high-quality JPG or WebP.</p>
                </div>
                <div>
                  ...
                  <p className="mt-1 text-[9px] text-neutral-500">If a video is uploaded, it replaces the image. Autoplays silently and loops. MP4 or WebM.</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white/40 p-4">
              <p className="mb-3 text-[9px] font-bold uppercase tracking-widest text-emerald-700">Appearance</p>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-[9px] text-neutral-500">Adds a dark gradient over the image so text stays readable. Higher = darker.</p>
                </div>

                <div>
                  <label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Text position</label>
                  <select className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={hero.align || 'left'} onChange={(e) => setHero('align', e.target.value)}>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className={`mt-6 space-y-6 ${split.enabled === false ? 'pointer-events-none opacity-40' : ''}`}>
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Eyebrow (small caps)</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={split.eyebrow || ''} onChange={(e) => setSplit('eyebrow', e.target.value)} placeholder="The Signature Edit" /></div>
                <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Title (Enter for new line)</label><textarea className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 min-h-16" value={split.title || ''} onChange={(e) => setSplit('title', e.target.value)} placeholder={'Premium,\nperfected.'} /></div>
                <div className="md:col-span-2"><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Subtitle</label><textarea className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 min-h-16" value={split.subtitle || ''} onChange={(e) => setSplit('subtitle', e.target.value)} /></div>
              </div>
              ...
              <div className="grid gap-3 md:grid-cols-4">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 font-mono text-xs" value={split.textColor || '#F7F5F1'} onChange={(e) => setSplit('textColor', e.target.value)} />
                  </div>
                </div>
                <div>
              ...
              <div className="rounded-2xl border border-neutral-200 bg-neutral-50/40 p-4">
                <p className="text-[9px] font-bold uppercase tracking-widest text-neutral-500">Left half — Women</p>
                <div className="mt-3 grid gap-3 md:grid-cols-2">
                  ...
                  <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">CTA button label</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={split.leftCtaLabel || ''} onChange={(e) => setSplit('leftCtaLabel', e.target.value)} placeholder="Shop Women" /></div>
                  <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">CTA link</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 font-mono text-xs" value={split.leftCtaHref || ''} onChange={(e) => setSplit('leftCtaHref', e.target.value)} placeholder="/women" /></div>
                </div>
              </div>

              {/* Right half */}
              <div className="rounded-2xl border border-neutral-200 bg-neutral-50/40 p-4">
                <p className="text-[9px] font-bold uppercase tracking-widest text-neutral-500">Right half — Men</p>
                <div className="mt-3 grid gap-3 md:grid-cols-2">
                  <div>
                    <label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Image</label>
                  ...
                  <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">CTA button label</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={split.rightCtaLabel || ''} onChange={(e) => setSplit('rightCtaLabel', e.target.value)} placeholder="Shop Men" /></div>
                  <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">CTA link</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 font-mono text-xs" value={split.rightCtaHref || ''} onChange={(e) => setSplit('rightCtaHref', e.target.value)} placeholder="/men" /></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Message (English)</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={offer.messageEn || ''} onChange={(e) => setOffer('messageEn', e.target.value)} /></div>
              <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Message (Urdu)</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" dir="rtl" value={offer.messageUr || ''} onChange={(e) => setOffer('messageUr', e.target.value)} /></div>
              <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Button text (EN)</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={offer.ctaEn || ''} onChange={(e) => setOffer('ctaEn', e.target.value)} /></div>
              <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Link</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" placeholder="/sale" value={offer.link || ''} onChange={(e) => setOffer('link', e.target.value)} /></div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className={`mt-4 ${marquee.enabled !== false ? '' : 'pointer-events-none opacity-40'}`}>
              ...
              <textarea className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 min-h-28" value={(marquee.items || []).join('\n')}
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className={`mt-4 grid gap-4 sm:grid-cols-2 ${promo.enabled !== false ? '' : 'pointer-events-none opacity-40'}`}>
              <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Kitne second baad dikhe</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" type="number" min="5" value={promo.delaySec} onChange={(e) => setPromo('delaySec', e.target.value)} /></div>
              <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Reward coupon code</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 uppercase" placeholder="WELCOME10" value={promo.couponCode || ''} onChange={(e) => setPromo('couponCode', e.target.value)} /></div>
              <div className="sm:col-span-2"><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Title</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" placeholder="Join the HUSHAE inner circle" value={promo.title || ''} onChange={(e) => setPromo('title', e.target.value)} /></div>
              <div className="sm:col-span-2"><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Text</label><textarea className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 min-h-16" value={promo.text || ''} onChange={(e) => setPromo('text', e.target.value)} /></div>
            </div>
            <p className="mt-3 rounded-xl bg-neutral-100 px-4 py-2.5 text-[9px] leading-relaxed text-neutral-500">⚠️ Use a coupon code that already exists on your <b>Discounts page</b> — otherwise checkout will reject it.</p>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <div className={`mt-4 grid gap-4 ${cookie.enabled !== false ? '' : 'pointer-events-none opacity-40'}`}>
              <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Popup title</label><input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900" value={cookie.title || ''} onChange={(e) => setCookie('title', e.target.value)} /></div>
              <div><label className="mb-1 block text-[10px] font-bold uppercase tracking-wider text-neutral-500">Popup text</label><textarea className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-[9px] outline-none transition focus:border-neutral-900 min-h-20" value={cookie.text || ''} onChange={(e) => setCookie('text', e.target.value)} /></div>
            </div>
          </div>

          <button onClick={save} disabled={busy} className="inline-flex items-center gap-1.5 rounded-full bg-neutral-900 px-4 py-2 text-[9px] font-semibold text-white hover:bg-black w-full lg:w-auto">{busy ? 'Saving…' : 'Save All Changes'}</button>
        </div>
        ...
        <div className="space-y-6 lg:sticky lg:top-8 lg:self-start">
          <div className="rounded-2xl border border-neutral-200 bg-white overflow-hidden">
            ...
            {offer.enabled && (
              <div className="flex items-center justify-center gap-2 bg-neutral-900 px-4 py-2 text-center text-[9px] text-white">
            ...
            {hero.fullScreen ? (
              <div className="relative h-72 overflow-hidden">
                ...
                <div className={`absolute inset-x-0 bottom-0 p-6 ${hero.align === 'center' ? 'text-center' : ''}`}>
                  ...
                  <p className={`mt-1.5 max-w-md text-[9px] leading-relaxed text-white/70 ${hero.align === 'center' ? 'mx-auto' : ''}`}>{hero.subtitle}</p>
              ...
              <div className="grid items-center gap-5 p-6 sm:grid-cols-2">
                <div>
                  ...
                  <div className="mt-4 flex gap-2">
                    <span className="inline-flex items-center gap-1.5 rounded-full bg-neutral-900 px-4 py-2 text-[9px] font-semibold text-white hover:bg-black !px-3 !py-2 text-[9px]">{hero.ctaWomen} <ArrowRight size={11} /></span>
                    <span className="inline-flex items-center gap-1.5 rounded-full border border-neutral-300 bg-white px-4 py-2 text-[9px] font-semibold text-neutral-700 hover:bg-neutral-50 !px-3 !py-2 text-[9px]">{hero.ctaMen}</span>
                  </div>
                </div>
                {hero.image
      ...
      <div className="mt-6 card p-6">
        <div className="flex items-start gap-3">
          ...
          <a href="/admin/faq" className="inline-flex items-center gap-1.5 rounded-full border border-neutral-300 bg-white px-4 py-2 text-[9px] font-semibold text-neutral-700 hover:bg-neutral-50 text-xs">Manage FAQ →</a>
        </div>
      </div>
    </AdminLayout>
  );
