...
const draftOrderSchema = new mongoose.Schema({
  ...
  shippingMode:   { type: String, enum: ['store', 'custom', 'none'], default: 'store' },
  customShipping: { type: Number, default: 0, min: 0 },
  taxExempt:      { type: Boolean, default: false },
  tags:           { type: [String], default: [] },
  linkedCustomerId: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null },
