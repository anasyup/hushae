...
export default function Collection() {
  ...
  if (err) {
    return (
      <div className="container-page pt-[190px] pb-24 text-center">
  ...
  if (!data) return (
    <div className="px-5 pt-[190px] pb-10 md:px-10">
  ...
  return (
    <div className="w-full min-h-screen bg-[#fcfbf9] pt-[190px] font-sans text-black">
      <Seo
        title={c.name}
