...
const CHIP_BASE = 'rounded-[2px] border text-caption font-semibold transition-colors duration-fast';
          ...
          {catList.map((c) => {
            ...
            return (
              <button
                ...
                className={`block w-full rounded-[2px] px-3 text-left text-body-sm transition-colors duration-fast ${touch ? 'py-3' : 'py-2'} ${
            ...
            return (
              <button
                ...
                /* PHASE 9. Squared with everything else. A circle reads as a
                   ...
                   removed in Phase 4. */
                className={`grid place-items-center rounded-[2px] border transition-[box-shadow,border-color] duration-fast ${
          ...
          {BADGES.map((bTech) => {
            ...
            return (
              <button
                ...
                className={`rounded-[2px] border text-caption font-medium transition-colors duration-fast ${chipPad} ${
