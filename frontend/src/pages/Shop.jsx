        ...
        {products === null ? (
          ...
          <>
            <div
              ...
              className={`grid grid-cols-2 gap-0 border-t border-l border-neutral-200/80 transition-opacity duration-300 lg:grid-cols-4 ${pending ? 'opacity-50' : 'opacity-100'}`}
            >
