    ...
    <div className="container-page py-6 md:py-10">
      ...
      <div className="grid gap-8 lg:grid-cols-[240px_minmax(0,1fr)]">
        ...
        <div className="min-w-0">
          {loading ? (
            <div className="grid grid-cols-2 gap-x-2 gap-y-6 md:grid-cols-3 xl:grid-cols-4" aria-hidden="true">
            ...
            <div>
              ...
              {data?.recovery?.products?.length > 0 && (
                <section className="mt-10" aria-labelledby="rec-popular">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-x-2 gap-y-6 md:grid-cols-3 xl:grid-cols-4">
