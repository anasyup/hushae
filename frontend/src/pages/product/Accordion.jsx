    ...
    <div className="border-b border-[#efe8dd]">
      <H>
        <button
          ...
          className="flex w-full items-center justify-between gap-4 py-4 text-left text-[12px] font-semibold uppercase tracking-[0.5px] text-[#1a1a1a] transition-colors duration-200 hover:text-[#666666]"
        >
          {title}
          <span
            aria-hidden="true"
      ...
      >
        <div className="min-h-0 overflow-hidden">
          <div className="pb-4 text-[12px] leading-[1.6] text-[#666666]">
            {children}
          </div>
        </div>
      </div>
