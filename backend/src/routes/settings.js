...
router.put('/', protect, adminOnly, asyncHandler(async (req, res) => {
  ...
  ['storeName', 'tagline', 'contactEmail', 'contactPhone', 'hero', 'trustBadges',
    'shippingFlatRate', 'freeShippingThreshold', 'paymentMethods', 'theme', 'offerBar', 'integrations', 'storefrontLock', 'cookiePopup', 'media', 'marquee', 'promoPopup', 'faq', 'operatingCosts'].forEach((f) => {
