 ...
 */
export default function ProductImageZoom({ src, alt = '', eager = false, ratioClass = 'aspect-[4/5]', frameClass = 'rounded-[2rem]' }) {
  ...
  return (
    <>
      <div
        ...
        className={`group relative ${ratioClass} ${frameClass} w-full overflow-hidden bg-satin/40 select-none`}
