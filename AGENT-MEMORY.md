...
- **ATELIER family ab:** Products + Categories + Collections (shared products-atelier.css chunk). Baqi pages (Customers, Reviews, Orders detail) same kit pe ho sakti hain.
