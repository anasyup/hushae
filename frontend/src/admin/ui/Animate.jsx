 ...
 *
 *  · CountUp   — the "number ticker": animates 0 → value over ~700ms, ease-out.
 *  · Rise      — fade + slide-up entrance used to stagger widgets on mount.
 *  · staggerOf — reading-order delay helper (30–50ms between widgets).
 * ========================================================================== */

const easeOut = [0.16, 1, 0.3, 1];

/** Animates a number from its previous value to `target` over `duration` ms.
    Returns the current value (Number) for rendering. Reduced motion → instant. */
...
/** Fade + slide-up wrapper. `delay` seconds; skips animation under reduced motion. */
...
/** Reading-order stagger — top-to-bottom, left-to-right. */
