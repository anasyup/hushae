...
export default function Rewards() {
  ...
  if (!auth?.token) {
    return (
      <div className="container-page py-sect-y pt-[150px]">
        <EmptyState
          icon={Sparkles}
          title={cfg.programName}
  ...
  return (
    <div className="container-page pt-[150px] pb-8 md:pb-12"><Seo title="Rewards" description="Earn points and rewards with every HUSHAE order." />
      {/* ---------------- balance ---------------- */}
